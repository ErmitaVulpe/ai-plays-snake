...
if __name__ == '__main__':
    ...
    for chunk in split_list_into_even_lists(trainingSet, num_processes):
        process = multiprocessing.Process(target=training_module.trainingInstance, args=(chunk,))
        process.start()
    ...
    # trainingSet = trainingInstance(trainingSet)
